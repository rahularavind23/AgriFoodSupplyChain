			...
			<div class="w3l_banner_nav_left">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li class="dropdown mega-dropdown active">
							...
							<div
								...
								<div class="w3ls_vegetables">
									<ul>
										<li>
											<a href="javascript:void(0)">Coolpad</a>
										</li>
										
										
										
										<li>
											<a href="javascript:void(0)">Lenova</a>
										</li>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Camera<span
								class="caret"></span> </a>
							<div
								class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
										...
										<li>
											<a href="javascript:void(0)">Kodak</a>
										</li>
										<li>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Laptop<span
								class="caret"></span> </a>
							<div
								class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">HeadPhone<span class="caret"></span> </a>
							<div
								class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">Television<span class="caret"></span> </a>
							<div
								class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
								<div class="w3ls_vegetables">
									<ul>
										...
										<li>
											<a href="javascript:void(0)">Videocon</a>
										</li>
										<li>
											<a href="javascript:void(0)">Onida</a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="w3_login_module">
						<div class="module form-module">
							...
							<div class="form">
								...
								<form action="CompanyOwenrLogin" method="post">
