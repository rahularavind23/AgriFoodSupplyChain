	...
	$(window).scroll(function() {
		...
		<div class="products-breadcrumb">
			...
			<ul>
				...
				<li>Welcome&nbsp;:-<label style="color: white;"><b>&nbsp;<%=name1 %></b></label></li>
			...
			<%--<div class="w3l_banner_nav_left">
				...
				<div id="myBtnContainer">
					<ul class="nav navbar-nav nav_1">
						<li><a href="Inventory?name=<%=sid %>&from=product" class="btns">ADD PRODUCT</a></li>
						<li><a href="ManufactureVi?name=<%=sid %>" class="btns">REQUEST PRODUCT</a></li>
						<li><a href="Inventory?name=<%=sid %>&from=inven" class="btns">INVENTORY</a></li>
