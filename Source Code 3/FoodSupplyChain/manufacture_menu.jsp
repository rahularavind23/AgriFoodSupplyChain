...
.closebtn:hover {
	color: black;
		...
		<%
			...
			String name = (String) session2.getAttribute("name");//manu_email
			String sid = (String) session2.getAttribute("id");
		%>
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<div id="myBtnContainer">
						<ul class="nav navbar-nav nav_1">
							...
							<li>
								<a href="manufacture.jsp" class="btns"
									style="background-color: black;">ADD SUPPLIER</a>
							</li>
							<li>
										...
										<div class="agile_top_brand_left_grid1">
											...
											<div class="snipcart-item block">
												<div class="snipcart-thumb">
													...
													<p>
														<b>Supplier Id 	&nbsp;:	&nbsp;</b><%=supid%></p>
													<p>
														<b>Product Id 	&nbsp;:	&nbsp;</b><%=proid%></p>
													<p>
														<b>Product Name 	&nbsp;:	&nbsp;</b><%=name1%></p>
													<p>
														<b>Description 	&nbsp;:	&nbsp;</b> <%=dese%></p>
														<p>
													...
													<p>
														...
														<b>Quanity 	&nbsp;:	&nbsp;</b> 
														<span id="q"><%=quan%> Kg</span>
													</p>
													<h4>
														<label style="background-color: black; color: white;">Rs.<%=a%></label></h4>
												</div>
												...
												<form action="ManufactureRequest" method="post">
													...
													<input type="hidden" name="proname" value='<%=name1%>'>
													<input type="hidden" name="proid" value='<%=proid%>'>
													<input type="hidden" name="price" value='<%=price%>'>
													<input type="hidden" name="onepro" value='<%=a%>'>
													<input type="text" id="quanity" name="quanity" onkeyup="validate(<%=quan%>,this.value,document.getElementById('<%=proid%>'))"
														required=" ">
													<center><input type="submit" value="Quantity" id="<%=proid%>" class="element"></center>
												</form>
											</div>
											</figure>
										</div>
