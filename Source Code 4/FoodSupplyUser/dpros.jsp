		...
		<div class="logo_products">
			<div class="container">
				<div class="w3ls_logo_products_left">
					<h1>
						<a href="#"><span>Smart</span> Store</a>
					</h1>
				</div>
			...
			<div
				...
				<div
					...
					<form method="post" action="ProductRequest">
						<table class="timetable_sub" id="myTable"
							...
							<tbody>
								<tr>
									...
									<td><%=disPojo.getDistributorPrice()%></td>
									<td><%=disPojo.getPackets()%></td>
									<td><%=disPojo.getPdate()%></td>
									<td><%=disPojo.getEdate()%></td>
									
									<td>
										<input type="checkbox"
											value="<%=disPojo.getManufacturer()%>#<%=disPojo.getDistributor()%>#<%=disPojo.getProductId()%>#<%=disPojo.getProductName()%>#<%=disPojo.getImage()%>#<%=disPojo.getPrice()%>#<%=disPojo.getDistributorPrice()%>#<%=disPojo.getPackets()%>#<%=disPojo.getPdate()%>#<%=disPojo.getEdate()%>#<%=disPojo.getQrcode()%>"
											name="pros" />
									</td>
								</tr>
							</tbody>
						...
						<br />
						<button
							style="margin-left: 300px; border-radius: 15px; background: mediumvioletred; color: white;">
